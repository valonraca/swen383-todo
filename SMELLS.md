...
Cost: There is four different reasons someone would need to
touch this file. If I want to add a second way to save tasks,
I would have to edit the same class that also handles validation,
...
typed out twice, and there is random numbers like 3, 20, and 40
